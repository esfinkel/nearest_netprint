...
printers_bw = [
    ...
    ['gs1','Goldwin Smith Hall - Room 338','campus-bw','42.44907329999999','-76.4835344',None],
    ...
    ['mseugrad','Bard Lab 247','campus-bw','42.4439614','-76.5018807',None],
    ['mth-372/mth-373/mth-374/mth-375','Myron Taylor Hall 2nd Floor Computer Lab','campus-bw','42.444460','-76.486113',None],
    ['mth-ilj','Myron Taylor Hall International Law Journal Office','campus-bw','42.444460','-76.486113',None],
    ['mth-jlpp','Myron Taylor Hall Journal Law and Public Policy Office','campus-bw','42.444460','-76.486113',None],
...
printers_color = [
    ...
    #['aap-nyc-1c','NYTech','campus-bw, campus-color','42.4439614','-76.5018807',None],
    ...
    ['aap-sib-3c','Sibley Hall - 2nd Floor Lab (ADMS])','campus-bw, campus-color','42.4509802','-76.4840158',None],
    ['aap-sib-3mfp/aap-sib-4c','Sibley Hall - 3rd Floor Balcony (inside dome)','campus-bw, campus-color','42.4509802','-76.4840158',None],
    ['aap-tjaden-1c','Tjaden Hall - Darkroom','campus-bw, campus-color','42.4509025','-76.4853131',{0:[9,16],1:[9,16],2:[9,16],3:[9,16],4:[9,16],5:[0,0],6:[0,0]}],
    ['aep-netprint1','Clark Hall - Room 244 (AEP only)','campus-bw, campus-color','42.4497606','-76.4812001',None,],
