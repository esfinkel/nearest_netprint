...
printers_bw = [
    ...
    ['catherwood-np1','Catherwood Library - 236 Ives Hall - Reference Area','campus-bw, campus-color','42.4472562','-76.4811158'],
    ['catherwood-np2','Catherwood Library - 236 Ives Hall - Reference Area','campus-bw, campus-color','42.4472562','-76.4811158'],
    ['catherwood-np3','Catherwood Library - 236 Ives Hall - Reference Area','campus-bw, campus-color','42.4472562','-76.4811158'],
    ['cisuglab','Gates Hall - Room G33','campus-bw','42.4449769','-76.4810912'],
    ['cit-carp-1bw','Carpenter Hall Computer Lab - Main Floor','campus-bw, campus-color','42.4856319','-76.4663403'],
    ['cit-carp-3bw','Carpenter Hall Computer Lab - Main Floor','campus-bw, campus-color','42.4856319','-76.4663403'],
    ['cit-carp-4bw','Carpenter Hall Computer Lab - Second Floor Hallway','campus-bw, campus-color','42.4856319','-76.4663403'],
    ['cit-carp-5bw','Carpenter Hall Computer Lab - Second Floor Hallway','campus-bw, campus-color','42.4856319','-76.4663403'],
    ['cit-mann220a-1bw','Mann Library Computer Lab - Room 220A - Second Floor','campus-bw, campus-color','42.448766','-76.4763118'],
    ['cit-mann220a-2bw','Mann Library Computer Lab - Room 220A - Second Floor','campus-bw, campus-color','42.448766','-76.4763118'],
    ['cit-ph318-1bw','Phillips Hall Computer Lab - Room 318','campus-bw, campus-color','42.4445768','-76.4820529'],
    ['cit-ph318-2bw','Phillips Hall Computer Lab - Room 318','campus-bw, campus-color','42.4445768','-76.4820529'],
    ['cit-rpcc-1bw','Robert Purcell Community Center - RPCC - Computer Lab - Room 207','campus-bw, campus-color','42.4562967','-76.4783146'],
    ['cit-rpcc-2bw','Robert Purcell Community Center - RPCC - Computer Lab - Room 207','campus-bw, campus-color','42.4562967','-76.4783146'],
    ['cit-surge-1bw','Ag Quad - Academic Surge B - Room 159','campus-bw, campus-color','42.4488081','-76.4780298'],
    ['cit-upson-1bw','Upson Hall - Room 225','campus-bw, campus-color','42.4439852','-76.4828736'],
    ['cit-upson-2bw','Upson Hall - Room 225','campus-bw, campus-color','42.4439852','-76.4828736'],
    ['cit-uris-1bw','Uris Library - Tower Room Computer Lab - Downstairs from Entrance','campus-bw, campus-color','42.447905','-76.484293'],
    ['cit-uris-2bw','Uris Library - Tower Room Computer Lab - Downstairs from Entrance','campus-bw, campus-color','42.447905','-76.484293'],
    ['cit-uris-3bw','Uris Library - Electronic Classroom - Room B05','campus-bw, campus-color','42.447905','-76.484293'],
    ['cit-wsh-1bw','Willard Straight Hall - Computer Lab - Basement Level','campus-bw, campus-color','42.4465919','-76.4856765'],
    ['cit-wsh-2bw','Willard Straight Hall - Computer Lab - Basement Level','campus-bw, campus-color','42.4465919','-76.4856765'],
    ...
    ['ilr-lab1','Ives Hall - Room 118 - Computer Lab','campus-bw, campus-color','42.4472571','-76.4811162'],
    ['ilr-lab2','Ives Hall - Room 118 - Computer Lab','campus-bw, campus-color','42.4472571','-76.4811162'],
    ...
    ['mann1','Mann Library - First Floor','campus-bw, campus-color','42.4487577','-76.47631179999999'],
    ['mann2','Mann Library - First Floor','campus-bw, campus-color','42.4487577','-76.47631179999999'],
    ['mann3','Mann Library - First Floor','campus-bw, campus-color','42.448766','-76.47631179999999'],
    ...
    ['mcfaddin1','McFaddin - Room G22 - Computer Lab','campus-bw','42.447337', '-76.487931'],
    ['mcfaddin2','McFaddin - Room G22 - Computer Lab','campus-bw','42.447337', '-76.487931'],
    ...
    ['mth-372','Myron Taylor Hall 2nd Floor Computer Lab','campus-bw','42.444460','-76.486113'],
    ['mth-373','Myron Taylor Hall 2nd Floor Computer Lab','campus-bw','42.444460','-76.486113'],
    ['mth-374','Myron Taylor Hall 2nd Floor Computer Lab','campus-bw','42.444460','-76.486113'],
    ['mth-375','Myron Taylor Hall 2nd Floor Computer Lab','campus-bw','42.444460','-76.486113'],
    ...
    ['olin-lib1','Olin Library - behind the reference desk','campus-bw, campus-color','42.447905','-76.484293'],
    ['olin-lib2','Olin Library - behind the reference desk','campus-bw, campus-color','42.447905','-76.484293'],
    ['olin-lib3','Olin Library - behind the reference desk','campus-bw, campus-color','42.447905','-76.484293'],
    ['olin-lib4','Olin Library - behind the reference desk','campus-bw, campus-color','42.447905','-76.484293'],
    ...
    ['orie-netprint2','Rhodes Hall - Room 453','campus-bw',42.4433613,-76.4812668],
    ['orie-netprint3','Rhodes Hall - Room 421','campus-bw',42.4433613,-76.4812668],
    ['physci-lib1','Clark Hall - Physical Sciences Library','campus-bw, campus-color','42.4497606','-76.4812001'],
    ['sage-205','Sage Hall - Room 205 Suite - Next to Dean\'s Office','campus-bw, campus-color','42.4458918','-76.4833009'],
    ['sage-205-bw2','Sage Hall - Room 205 Suite - Next to Dean\'s Office','campus-bw','42.4458918','-76.4833009'],
    ['sage-301-bw','Sage Hall Library - Room 301 - Third Floor Collaboration Space','campus-bw, campus-color','42.4458947','-76.4832581'],
    ['sage-basement-a','Sage Hall - Basement - Near Student Mailboxes','campus-bw','42.4458918','-76.4833009'],
    ['sage-basement-b','Sage Hall - Basement - Near Student Mailboxes','campus-bw','42.4458918','-76.4833009'],
    ['sage-lib1-bw','Sage Hall - Library - First Floor','campus-bw','42.4458918','-76.4833009'],
    ['sage-lib2-bw','Sage Hall - Library - First Floor','campus-bw','42.4458918','-76.4833009'],
    ...
    ['sha-mslc-front1','Nestle Library - west side of reference desk','campus-bw',42.446092,-76.4815932],
    ['sha-mslc-front2','Nestle Library - west side of reference desk','campus-bw',42.446092,-76.4815932],
    ['sha-mslc-front3','Nestle Library - west side of reference desk','campus-bw',42.446092,-76.4815932],
    ...
    ['vm-wiswall-01','Wiswall Lab','campus-bw','42.4799809','-76.4511259'],
    ['vm-wiswall-02','Wiswall Lab','campus-bw','42.4799809','-76.4511259'],
...
printers_color = [
    ...
    ['aap-mil-1mfp','Milstein Hall - Behind the elevators (2nd floor],','campus-bw, campus-color','42.451232','-76.4836401'],
    ['aap-mil-2mfp','Milstein Hall - Behind the elevators (2nd floor],','campus-bw, campus-color','42.451232','-76.4836401'],
    ['aap-mil-3mfp','Milstein Hall - Behind the elevators (2nd floor],','campus-bw, campus-color','42.451232','-76.4836401'],
    ['aap-mil-4mfp','Milstein Hall - Behind the elevators (2nd floor],','campus-bw, campus-color','42.451232','-76.4836401'],
    ...
    ['aap-sib-3mfp','Sibley Hall - 3rd Floor Balcony (inside dome],','campus-bw, campus-color','42.4509802','-76.4840158'],
    ['aap-sib-4c','Sibley Hall - 3rd Floor Balcony (inside dome],','campus-bw, campus-color','42.4509802','-76.4840158'],
    ...
    ['kroch-lib-2-mfp','Kroch Library','campus-bw, campus-color','42.447774','-76.484160'],
    ['kroch-lib-3-mfp','Kroch Library','campus-bw, campus-color','42.447774','-76.484160'],
    ...
    ['mann-mfp1','Mann','campus-bw, campus-color','42.448766','-76.47631179999999'],
    ['mann-mfp2','Mann','campus-bw, campus-color','42.448766','-76.47631179999999'],
    ...
    ['sage-mfp2','Sage','campus-bw, campus-color','42.4397199','-76.49146619999999'],
    ['sage-mfp3','Sage','campus-bw, campus-color','42.4397199','-76.49146619999999'],
